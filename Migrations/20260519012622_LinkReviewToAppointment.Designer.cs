...
namespace FleetFactoryBackend.Migrations
{
    ...
    [Migration("20260519012622_LinkReviewToAppointment")]
    partial class LinkReviewToAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetFactory.Domain.Entities.CustomerProfile", b =>
                {
                    b.HasOne("FleetFactory.Infrastructure.Identity.ApplicationUser", "User")
            ...
            modelBuilder.Entity("FleetFactory.Domain.Entities.Review", b =>
                {
                    b.HasOne("FleetFactory.Domain.Entities.Appointment", "Appointment")
                        .WithOne("Review")
                        .HasForeignKey("FleetFactory.Domain.Entities.Review", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
